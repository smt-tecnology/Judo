    ...
    <section class="galeria">
        ...
        <div class="container text-center">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 videos"><iframe width="560" height="315" src="https://www.youtube.com/embed/0Jihou2IwGM" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
            </div>
        </div>\
        <br><br><br>
        <!-- FIN VIDEOS -->
